#!/bin/bash
# Taken directly from https://raspiaudio.com/s/mic1
: <<'DISCLAIMER'
...
productname="Raspiaudio MIC+ " # the name of the product to install
...
if confirm "Do you wish to continue?"; then
    ...
    sudo cp /etc/asound.conf /home/$USER/.asoundrc
    sleep 1
    sudo chown $USER /home/$USER/.asoundrc
    sudo chgrp $USER /home/$USER/.asoundrc
